...
/**
* LLProcessImage class.
*
* <p>An OpenCV pipeline generated by GRIP.
*
* @author GRIP
*/
public class LLProcessImage {
	 ...
	 */
	public RotatedRect[] process(Mat source0) {
		// Step RGB_Threshold0:
		...
		for(MatOfPoint con : filterContoursOutput){
			rects.add(Imgproc.minAreaRect(new MatOfPoint2f(con)));
		}
